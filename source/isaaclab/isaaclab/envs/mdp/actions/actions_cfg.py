...
class FourLegsPMTGActionCfg(ActionTermCfg):
    ...
    class TrajectoryGeneratorCfg:
        ...
        default_frequency: float = 2.0
        """Default frequency (Hz). Defaults to 2.0."""
        default_step_length_x: float = 0.0
        """Default step length in the X direction (m). Defaults to 0.0."""
        default_length_y: float = 0.0
        """Default step length in the Y direction (m). Defaults to 0.0."""
        default_height: float = 0.1
        """Default step height (m). Defaults to 0.1."""
